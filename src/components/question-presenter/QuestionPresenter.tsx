...
const DEFAULT_CORRECT_MESSAGE: string = "The answer is correct!";
const DEFAULT_INCORRECT_MESSAGE: string = "The answer is incorrect";
...
const QuestionPresenter: React.FC<QuestionPresenterProps> = ({
    ...
    useEffect(() => {
        ...
        const initAnswerOptions = shuffleArray(answerOptions.map(answerOption => {
    ...
    useEffect(() => {
        setCorrectAnswers(() => answerOptions.reduce((numCorrect, answerOption) => {
